...
#define ENEMY_START_POS CVector(10.0f, 0.0f, 0.0f),CVector(-10.0f, 0.0f, 0.0f),CVector(0.0f, 0.0f, -10.0f) //“G‚Ì‰ŠúÀ•W1
...
public:
	...
	void EnemyGenerate(int num,int type); //“G¶¬Aˆø”‚Å¶¬”‚Æ“G‚Ìí—Ş‚ğw’è‚·‚é
